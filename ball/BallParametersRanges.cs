public partial class BallParametersRanges
{
    public const float MinMassValue = 0.41f;
    public const float MaxMassValue = 0.45f;
    public const float MinRadiusValue = 0.10822536f;
    public const float MaxRadiusValue = 0.11140846f;
    public const float MinDiameterValue = 0.21645072f;
    public const float MaxDiameterValue = 0.22281691f;
    public const float MinCircumferenceValue = 0.68f;
    public const float MaxCircumferenceValue = 0.70f;
    public const float MinCoefficientOfRestitutionValue = 0.1f;
